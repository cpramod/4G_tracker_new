...
export default function Index({ auth, sites, get_data, batch, additional_columns, hidden_columns, renamed_columns, deleted_columns, arrange_columns }) {
    ...
    const fw_sites_header = [
        ...
        { name: 'Cell Name', sortable: true, key: 'cell_name', position: 2, editable: true, input_type: "text" },
        { name: 'Lon', sortable: true, key: 'lon', position: 3, editable: true, input_type: "text" },
        { name: 'Lat', sortable: true, key: 'lat', position: 4, editable: true, input_type: "text" },
        { name: 'BB Type', sortable: true, key: 'bb_type', position: 5, editable: true, input_type: "text" },
        { name: 'RRU Type', sortable: true, key: 'rru_type', position: 6, editable: true, input_type: "text" },
        { name: 'Antenna Type', sortable: true, key: 'antenna_type', position: 7, editable: true, input_type: "text" },
        { name: 'Frequency', sortable: true, key: 'frequency', position: 8, editable: true, input_type: "text" },
        { name: 'PCI', sortable: false, key: 'pci', position: 9, editable: true, input_type: "text" },
        { name: 'Azimuth', sortable: false, key: 'azimuth', position: 10, editable: true, input_type: "text" },
        { name: 'Height', sortable: false, key: 'height', position: 11, editable: true, input_type: "text" },

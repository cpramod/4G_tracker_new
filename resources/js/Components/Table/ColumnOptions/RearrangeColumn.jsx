...
export default function RearrangeColumn({ arrangeColumnDialog, setArrangeColumnDialog, columns }) {
    ...
    const onSubmitHandler = (e) => {
        e.preventDefault();
        post(route('table.rearrange.column'), {
            onSuccess: () => {
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-3 border py-2 px-2 rounded-md ">
                                    ...
                                    {item?.alternative_name ? item?.alternative_name : item.name}
                                </div>
                            </div>
                        )
                    })}

...
to {
  ...
  animation: ${De} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,ze=({toast:e})=>{let{icon:t,type:s,iconTheme:i}=e;return t!==void 0?typeof t=="string"?u.createElement(Ie,null,t):t:s==="blank"?null:u.createElement(Le,null,u.createElement(ke,{...i}),s!=="loading"&&u.createElement(Ee,null,s==="error"?u.createElement(je,{...i}):u.createElement(Ce,{...i})))},Oe=e=>`

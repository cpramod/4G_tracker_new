...
`,Me="0%{opacity:0;} 100%{opacity:1;}",Pe="0%{opacity:1;} 100%{opacity:0;}",Te=j("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;

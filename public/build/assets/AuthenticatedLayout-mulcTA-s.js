import{r as p,j as r,a as N}from"./app-BD4exc6D.js";import{q as W}from"./transition-DZudH7DT.js";import{r as m}from"./index-BgYelr_x.js";import{c as w}from"./createLucideIcon-DKJgpQql.js";const F=p.createContext(),M=({children:e})=>{const[t,s]=p.useState(!1),i=()=>{s(o=>!o)};return r.jsx(F.Provider,{value:{open:t,setOpen:s,toggleOpen:i},children:r.jsx("div",{className:"relative",children:e})})},Z=({children:e})=>{const{open:t,setOpen:s,toggleOpen:i}=p.useContext(F);return r.jsxs(r.Fragment,{children:[r.jsx("div",{onClick:i,children:e}),t&&r.jsx("div",{className:"fixed inset-0 z-40",onClick:()=>s(!1)})]})},J=({align:e="right",width:t="48",contentClasses:s="py-1 bg-white dark:bg-gray-700",children:i})=>{const{open:o,setOpen:a}=p.useContext(F);let n="origin-top";e==="left"?n="ltr:origin-top-left rtl:origin-top-right start-0":e==="right"&&(n="ltr:origin-top-right rtl:origin-top-left end-0");let l="";return t==="48"&&(l="w-48"),r.jsx(r.Fragment,{children:r.jsx(W,{as:p.Fragment,show:o,enter:"transition ease-out duration-200",enterFrom:"opacity-0 scale-95",enterTo:"opacity-100 scale-100",leave:"transition ease-in duration-75",leaveFrom:"opacity-100 scale-100",leaveTo:"opacity-0 scale-95",children:r.jsx("div",{className:`absolute z-50 mt-2 rounded-md shadow-lg ${n} ${l}`,onClick:()=>a(!1),children:r.jsx("div",{className:"rounded-md ring-1 ring-black ring-opacity-5 "+s,children:i})})})})},U=({className:e="",children:t,...s})=>r.jsx(N,{...s,className:"block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-800 transition duration-150 ease-in-out "+e,children:t});M.Trigger=Z;M.Content=J;M.Link=U;const $=M;/**
